...
import { getHomeScopeItems, getProjectCollections, getProjectHomeSummary, rememberRecentCollection, rememberRecentProject } from './homeScope';
...
describe('Home project and collection scope', () => {
  ...
  it('keeps a bounded most-recent-first project switcher', () => {
    expect(rememberRecentProject(['p2', 'p1', 'p3', 'p4', 'p5'], 'p1')).toEqual([
      'p1',
      'p2',
      'p3',
      'p4',
    ...
    expect(rememberRecentProject(['p1', 'p2', 'p3', 'p4', 'p5'], 'p6')).toEqual([
      'p6',
      'p1',
      'p2',
      'p3',
