    ...
    content: (
      <>
        ...
        <GuideSteps steps={[
            ...
            <>Open <strong>Preview</strong> to review an item without leaving Search. Click a card in the compact gallery above the detail to open that item; its arrows browse gallery pages independently. For larger result sets, <strong>See full gallery</strong> opens a 60-card paged browser with direct page jumping.</>,
    ...
    content: (
      <>
        <DefinitionGrid entries={[
          ...
          { icon: Layers3, term: 'Group selection', description: <>Saved-item lists and Search results are always selectable with their checkboxes. Optionally filter first, then use <strong>Select all</strong>, <strong>Clear</strong>, and <strong>Organize selected</strong>. Clicking the rest of a row still inspects it, and dragging any selected row carries the same group.</> },
