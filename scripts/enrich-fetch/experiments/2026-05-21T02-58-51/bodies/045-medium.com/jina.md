[![Image 1: Alexey Kutovenko](https://miro.medium.com/v2/resize:fill:32:32/0*fOgpcGgITTTVlh7h.)](https://medium.com/@kutovenko?source=post_page---byline--645791c312fa---------------------------------------)
...
![Image 2](https://miro.medium.com/v2/resize:fit:700/1*0h8e7K6qsIG6fv7BchwHEg.png)
...
final alternatives =
 ...
 decoded.map((a) => Alternative(a['text'], a['confidence'])).toList();

 //Find out if VOSK has no alternatives
