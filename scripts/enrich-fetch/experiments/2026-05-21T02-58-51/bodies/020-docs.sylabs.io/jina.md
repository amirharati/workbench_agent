...
## Installation on Linux[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#installation-on-linux "Permalink to this heading")
...
### System Requirements[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#system-requirements "Permalink to this heading")
...
#### Filesystem support / limitations[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#filesystem-support-limitations "Permalink to this heading")
...
##### Overlay support[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#overlay-support "Permalink to this heading")
...
##### Fakeroot / (sub)uid/gid mapping[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#fakeroot-sub-uid-gid-mapping "Permalink to this heading")
...
##### Singularity cache / atomic rename[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#singularity-cache-atomic-rename "Permalink to this heading")
...
##### NFS[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#nfs "Permalink to this heading")
...
##### Lustre / GPFS[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#lustre-gpfs "Permalink to this heading")
...
### Before you begin[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#before-you-begin "Permalink to this heading")

If you have an earlier version of Singularity installed, you should [remove it](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#remove-an-old-version) before executing the installation commands. You will also need to install some dependencies and install [Go](https://golang.org/).

### Install from Source[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-from-source "Permalink to this heading")
...
#### Install Dependencies[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#id1 "Permalink to this heading")
...
#### Install Go[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-go "Permalink to this heading")
...
#### Download Singularity from a release[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#download-singularity-from-a-release "Permalink to this heading")
...
#### Checkout Code from Git[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#checkout-code-from-git "Permalink to this heading")
...
#### Compile Singularity[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#compile-singularity "Permalink to this heading")
...
#### Unprivileged (non-setuid) Installation[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#unprivileged-non-setuid-installation "Permalink to this heading")
...
#### Source bash completion file[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#source-bash-completion-file "Permalink to this heading")
...
### Build and install an RPM[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#build-and-install-an-rpm "Permalink to this heading")
...
After installing the [dependencies](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-dependencies) and installing [Go](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-go) as detailed above, you are ready to download the tarball and build and install the RPM.
...
#### Build an RPM from Git source[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#build-an-rpm-from-git-source "Permalink to this heading")
...
For finer control of the rpmbuild process you may wish to use 
```
make
dist
```
 to create a tarball that you can then build into an rpm with `rpmbuild -tb` as above.

### Remove an old version[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#remove-an-old-version "Permalink to this heading")
...
If you anticipate needing to remove Singularity, it might be easier to install it in a custom directory using the `--prefix` option to `mconfig`. In that case Singularity can be uninstalled simply by deleting the parent directory. Or it may be useful to install Singularity [using a package manager](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-rpm) so that it can be updated and/or uninstalled with ease in the future.

### Distribution packages of Singularity[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#distribution-packages-of-singularity "Permalink to this heading")
...
#### Install the CentOS/RHEL package using yum[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#install-the-centos-rhel-package-using-yum "Permalink to this heading")
...
### Testing & Checking the Build Configuration[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#testing-checking-the-build-configuration "Permalink to this heading")
...
#### singularity buildcfg[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#singularity-buildcfg "Permalink to this heading")
...
#### Test Suite[](https://docs.sylabs.io/guides/3.7/admin-guide/installation.html#test-suite "Permalink to this heading")
