...
![Amorn Apichattanakul](https://miro.medium.com/v2/resize:fill:32:32/1*xUHBdMSNjq6ci0K1-sBt2Q.png)



](https://medium.com/@benamorn?source=post_page---byline--6997edd28b29---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:571/1*Ro5LGPDzopVCyvyMjJhcwg.jpeg)
...
This led me to explore the inner workings of Flutter camera packages to understand how they transmit information to Flutter. After conducting research, I identified a suitable package that aligns with my requirements in the name of ‘**mobile\_scanner**’.
...
![](https://miro.medium.com/v2/resize:fit:700/1*yfTlWe4xvRgCbhm0DLqQpg.png)

FaceLiveness with Native Camera, iPhone 14 Pro Max

Press enter or click to view image in full size

![](https://miro.medium.com/v2/resize:fit:700/1*I1r_1FLy1vjuUk9gQl55IA.png)
...
s.pod\_target\_xcconfig = { 'DEFINES\_MODULE' => 'YES', 'EXCLUDED\_ARCHS\[sdk=iphonesimulator\*\]' => 'i386' }  
s.swift\_version = '5.0'  
s.preserve\_paths = 'xxx.xcframework/\*\*/\*'  
s.xcconfig = { 'OTHER\_LDFLAGS' => '-framework xxx' }  
s.vendored\_frameworks = 'xxx.xcframework'
...
That wraps up everything, and I believe this is the final solution for my camera with ML. I don’t foresee further improvements unless I venture into the Native development. However, my next task involves enhancing our QR code reader in Flutter. While mobile\_scanner is already fast and usable without any issues, our team aims to achieve native-level speed. In the next article, I’ll detail the implementation of Flutter, communication with Native, and assess whether the performance surpasses that of mobile\_scanner. Let’s find out!
...
![](https://miro.medium.com/v2/resize:fit:700/1*PyO3-Qi0U4QUL0OgEjSEYQ.png)