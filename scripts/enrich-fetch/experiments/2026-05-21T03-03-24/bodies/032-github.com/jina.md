[![Image 1: Twitter](https://camo.githubusercontent.)](https://x.com/AlgoVPN)
...
[](https://github.com/trailofbits/algo#features)
...
*   Installs to DigitalOcean, Amazon Lightsail, Amazon EC2, Vultr, Microsoft Azure, Google Compute Engine, Scaleway, OpenStack, CloudStack, Hetzner Cloud, Linode, or [your own Ubuntu server (for advanced users)](https://github.com/trailofbits/algo/blob/main/docs/deploy-to-ubuntu.md)

## Anti-features

[](https://github.com/trailofbits/algo#anti-features)
...
The easiest way to get an Algo server running is to run it on your local system or from [Google Cloud Shell](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-cloudshell.md) and let it set up a _new_ virtual machine in the cloud for you.
...
If you prefer to use the built-in IPsec VPN on Apple devices, or need "Connect on Demand" or excluded Wi-Fi networks automatically configured, see the [Apple IPsec client setup guide](https://github.com/trailofbits/algo/blob/main/docs/client-apple-ipsec.md) for detailed configuration instructions.

### Android

[](https://github.com/trailofbits/algo#android)
WireGuard is used to provide VPN services on Android. Install the [WireGuard VPN Client](https://play.google.com/store/apps/details?id=com.wireguard.android). Import the corresponding `wireguard/<name>.conf` file to your device, then set up a new connection with it. See the [Android setup guide](https://github.com/trailofbits/algo/blob/main/docs/client-android.md) for detailed installation and configuration instructions.

### Windows

[](https://github.com/trailofbits/algo#windows)
...
Install the [WireGuard VPN Client](https://www.wireguard.com/install/#windows-7-8-81-10-2012-2016-2019). Import the generated `wireguard/<username>.conf` file to your device, then set up a new connection with it. See the [Windows setup instructions](https://github.com/trailofbits/algo/blob/main/docs/client-windows.md) for more detailed walkthrough and troubleshooting.

### Linux

[](https://github.com/trailofbits/algo#linux)
Linux clients can use either WireGuard or IPsec:

WireGuard: WireGuard works great with Linux clients. See the [Linux WireGuard setup guide](https://github.com/trailofbits/algo/blob/main/docs/client-linux-wireguard.md) for step-by-step instructions on configuring WireGuard on Ubuntu and other distributions.

IPsec: For strongSwan IPsec clients (including OpenWrt, Ubuntu Server, and other distributions), see the [Linux IPsec setup guide](https://github.com/trailofbits/algo/blob/main/docs/client-linux-ipsec.md) for detailed configuration instructions.

### OpenWrt

[](https://github.com/trailofbits/algo#openwrt)
For OpenWrt routers using WireGuard, see the [OpenWrt WireGuard setup guide](https://github.com/trailofbits/algo/blob/main/docs/client-openwrt-router-wireguard.md) for router-specific configuration instructions.

### Other Devices

[](https://github.com/trailofbits/algo#other-devices)
...
[](https://github.com/trailofbits/algo#setup-an-ssh-tunnel)
...
[](https://github.com/trailofbits/algo#ssh-into-algo-server)
...
[](https://github.com/trailofbits/algo#privacy-and-logging)
...
[](https://github.com/trailofbits/algo#additional-documentation)
*   [FAQ](https://github.com/trailofbits/algo/blob/main/docs/faq.md)
*   [Troubleshooting](https://github.com/trailofbits/algo/blob/main/docs/troubleshooting.md)
*   How Algo uses [Firewalls](https://github.com/trailofbits/algo/blob/main/docs/firewalls.md)

### Setup Instructions for Specific Cloud Providers

[](https://github.com/trailofbits/algo#setup-instructions-for-specific-cloud-providers)
*   Configure [Amazon EC2](https://github.com/trailofbits/algo/blob/main/docs/cloud-amazon-ec2.md)
*   Configure [Azure](https://github.com/trailofbits/algo/blob/main/docs/cloud-azure.md)
*   Configure [DigitalOcean](https://github.com/trailofbits/algo/blob/main/docs/cloud-do.md)
*   Configure [Google Cloud Platform](https://github.com/trailofbits/algo/blob/main/docs/cloud-gce.md)
*   Configure [Vultr](https://github.com/trailofbits/algo/blob/main/docs/cloud-vultr.md)
*   Configure [CloudStack](https://github.com/trailofbits/algo/blob/main/docs/cloud-cloudstack.md)
*   Configure [Hetzner Cloud](https://github.com/trailofbits/algo/blob/main/docs/cloud-hetzner.md)

### Install and Deploy from Common Platforms

[](https://github.com/trailofbits/algo#install-and-deploy-from-common-platforms)
*   Deploy from [macOS](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-macos.md)
*   Deploy from [Windows](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-windows.md)
*   Deploy from [Google Cloud Shell](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-cloudshell.md)
*   Deploy from a [Docker container](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-docker.md)

### Setup VPN Clients to Connect to the Server

[](https://github.com/trailofbits/algo#setup-vpn-clients-to-connect-to-the-server)
*   Setup [Windows](https://github.com/trailofbits/algo/blob/main/docs/client-windows.md) clients
*   Setup [Android](https://github.com/trailofbits/algo/blob/main/docs/client-android.md) clients
*   Setup [Linux](https://github.com/trailofbits/algo/blob/main/docs/client-linux.md) clients with Ansible
*   Setup Ubuntu clients to use [WireGuard](https://github.com/trailofbits/algo/blob/main/docs/client-linux-wireguard.md)
*   Setup Linux clients to use [IPsec](https://github.com/trailofbits/algo/blob/main/docs/client-linux-ipsec.md)
*   Setup Apple devices to use [IPsec](https://github.com/trailofbits/algo/blob/main/docs/client-apple-ipsec.md)
*   Setup Macs running macOS 10.13 or older to use [WireGuard](https://github.com/trailofbits/algo/blob/main/docs/client-macos-wireguard.md)

### Advanced Deployment

[](https://github.com/trailofbits/algo#advanced-deployment)
*   Deploy to your own [Ubuntu](https://github.com/trailofbits/algo/blob/main/docs/deploy-to-ubuntu.md) server, and road warrior setup
*   Deploy from [Ansible](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-ansible.md) non-interactively
*   Deploy onto a [cloud server at time of creation with shell script or cloud-init](https://github.com/trailofbits/algo/blob/main/docs/deploy-from-script-or-cloud-init-to-localhost.md)
*   Deploy to an [unsupported cloud provider](https://github.com/trailofbits/algo/blob/main/docs/deploy-to-unsupported-cloud.md)
...
[](https://github.com/trailofbits/algo#endorsements)
...
> Before picking a VPN provider/app, make sure you do some research [https://research.csiro.au/ng/wp-content/uploads/sites/106/2016/08/paper-1.pdf](https://research.csiro.au/ng/wp-content/uploads/sites/106/2016/08/paper-1.pdf) ... – or consider Algo
...
[](https://github.com/trailofbits/algo#contributing)
See our [Development Guide](https://github.com/trailofbits/algo/blob/main/docs/DEVELOPMENT.md) for information on:
...
[](https://github.com/trailofbits/algo#support-algo-vpn)
[![Image 2: PayPal](https://camo.githubusercontent.com/7b6de155df30b37b25eb5fec52f9213680c3dbf067dfb7d7e2850ac4096c7d05/68747470733a2f2f7777772e70617970616c6f626a656374732e636f6d2f656e5f55532f692f62746e2f62746e5f646f6e6174655f534d2e676966)](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=CYZZD39GXUJ3E)[![Image 3: Patreon](https://camo.githubusercontent.com/6d744c4ba32d4c1877b7831ff40d45eaa99e5f4c75e4326b26a1a9d89ee7a3a4/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f6261636b5f6f6e2d70617472656f6e2d7265642e737667)](https://www.patreon.com/algovpn)
