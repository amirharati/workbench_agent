...
![A screenshot of a pub.dev search for the term ONNX. Four results show up. Each has a small number of likes and low popularity.](https://devblogs.microsoft.com/surface-duo/wp-content/uploads/sites/53/2023/12/a-screenshot-of-a-pub-dev-search-for-the-term-onnx.png)  
...
![Screenshot of the Netron app, with a simple model open that requires two float inputs. The model outputs a single float value.](https://devblogs.microsoft.com/surface-duo/wp-content/uploads/sites/53/2023/12/screenshot-of-the-netron-app-with-a-simple-model.png)  
...
![Screenshot of the Netron app, with a model open that requires large float matrices as input and output. The model is complex and large.](https://devblogs.microsoft.com/surface-duo/wp-content/uploads/sites/53/2023/12/screenshot-of-the-netron-app-with-a-model-open-th.png)  
...
![A red square. The red used here is the purest red available to a computer, meaning a 255 value for red and 0 for green and blue. This is typically represented as #FF0000](https://devblogs.microsoft.com/surface-duo/wp-content/uploads/sites/53/2023/12/a-red-square-the-red-used-here-is-the-purest-red.png)  
_Figure 5: Red square_

![A square split down the middle vertically. The left side is red and the right side is green.](https://devblogs.microsoft.com/surface-duo/wp-content/uploads/sites/53/2023/12/a-square-split-down-the-middle-vertically-the-lef.png)  
