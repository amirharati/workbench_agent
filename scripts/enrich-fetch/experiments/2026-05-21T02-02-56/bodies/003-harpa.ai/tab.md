![](https://harpa.ai/img/icons/annotation-question.svg)

## What is HARPA AI?

HARPA AI is a browser extension, powered by hybrid AI-engine that combines ChatGPT, Gemini, ClaudeAI, Perplexity, DeepSeek with Web Automation. Read the [Get Started Guide](https://harpa.ai/guides) to find out more.

![](https://harpa.ai/img/icons/annotation-question.svg)

## What is it used for?

HARPA automates your copywriting, email management, web search, online data extraction and web monitoring tasks.

It is used to quickly write and reply to emails, post comments and DMs, summarise and “talk to” web pages, YouTube videos, PDF documents, extract and research SEO keywords, create SMM content plans and Midjourney prompts, automate form filling, write blog articles, review CVs, job offers and legal documents, plan trips, track competitors, prices and SERP pages, create learning plans, search for information and more.

![](https://harpa.ai/img/icons/target-04.svg)
...
Ultimate copilot and AI Agent for your web browsing, search and automation tasks. It provides access to AI on any website, and you can use HARPA with almost every web service or online app.

![](https://harpa.ai/img/icons/coins-04.svg)

## Is HARPA free?

HARPA has a basic free tier and a demo period for it's premium features. You can try the app before making an informed purchase.

Basic **S** plan starts with **$12 per month** paid annually, includes CloudGPT connection, cloud command storage, chat history [and more](https://harpa.ai/pricing).

![](https://harpa.ai/img/icons/cpu-chip-01.svg)
...
![](https://harpa.ai/img/icons/announcement-01.svg)
...
![](https://harpa.ai/img/icons/star-06.svg)

## Do I need to have an OpenAI account?

Generative AI features require connection to AI service providers. You can use HARPA with ChatGPT account, OpenAI API key, ClaudeAI, Google Gemini, OpenRouter and API keys.

You can also connect to our CloudGPT on S plan.

![](https://harpa.ai/img/icons/star-06.svg)

## How to create ChatGPT account?

Step 1: Navigate to the [ChatGPT login page](https://chatgpt.com/auth/login). Click Sign Up button. ChatGPT offers three options for new user registration:
...
## How to get access to GPT-5.4?

HARPA CloudGPT supports GPT-5.4 model. Please [upgrade to S plan](https://harpa.ai/pricing) to get access to GPT-5.4.

Alternatively, GPT-5.4 comes with ChatGPT Plus. It is limited by OpenAI's per-session rate limits. GPT-5.4 is also available for OpenAI API accounts.
...
To create OpenAI account and generate a key, navigate to [openai.com](https://openai.com/)
...
Alternatively, type **\-3** in chat and press Enter to switch model to an efficient model, **\-4** to switch to a premium model, **\-c** to switch to Claude, etc.

![](https://harpa.ai/img/icons/shield-tick.svg)
...
[Privacy Policy](https://harpa.ai/privacy)

![](https://harpa.ai/img/icons/check-health.svg)
...
## Why do I get CRX\_FILE\_NOT\_READABLE error?
...
You can see 🧬  chats in chatgpt.com if you're on a Browser Session connection. If you don’t want your dialogues to be cleared automatically whenever a tab is closed, you can change this in the App Settings.
...
![](https://harpa.ai/img/icons/tool-02.svg)
...
## Which API connection is better than Browser Session?

HARPA S plan comes with CloudGPT, which is the most reliable, fastest and non country restricted GPT connection. You can also use CloudGPT or OpenAI keys with HARPA with an additional setup.
...
*   GPT-5.4 access is unlimited on OpenAI API key connection. Browser Session Plus has per-session rate limits.
...
Yes, this feature is available on **HARPA S** plan. Please note the dialogue content is not stored on our servers and is not synched between your devices.

![](https://harpa.ai/img/icons/annotation-question.svg)

## What is a Prompt and AI Command?

A prompt is a message (instruction) your send to Large Language Model (LLM) such as OpenAI GPT-5. AI Command is an automation recipe which may or may not include steps that prompt LLMs.
...
You can also create custom parameters in your commands to store data or options. Custom parameters are usually named {{p1}}, {{p2}}… You can also set up global parameters such as {{g.tone}} and reuse them in your prompts e.g. to write customised emails.

![](https://harpa.ai/img/icons/annotation-question.svg)

## How chunking works?

Large Language Models have a limited token window, e.g. 8192 tokens on ChatGPT 3.5. It is often impractical or impossible to fit large documents, web pages, and video transcripts into a single GPT request.

[Chunking](https://harpa.ai/guides/chunking) is a technique that divides content into smaller parts, also called chunks, to ensure that each part, including the prompt, fits within the GPT token limit. These chunks are then injected into prompts as {{chunk}} parameters and processed by GPT one by one.
...
![](https://harpa.ai/img/icons/translate-01.svg)

## How to change AI response or UI language?

Both the AI response language and the UI language can be changed in the HARPA AI settings at the top of the settings list. You can also send {{language}} parameter in chat along with your prompts to instruct AI to reply in a given language.

![](https://harpa.ai/img/icons/puzzle-piece-01.svg)

## Does HARPA have a CloudAI API?

Yes. HARPA S plan comes with CloudAI API, and provides reliable access to OpenAI and ClaudeAI models.
